    ...
    def move(self, direction):
        ...
        if current_board != None:
            if keyboard.is_pressed(direction):
                if (direction == "right"):
                    if (isinstance(current_board, Board)) and (0 <= self.__x+1 < current_board.width):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__x += 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    elif (not isinstance(current_board, Board)) and (0 <= self.__x+1 < len(current_board[0])):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__x += 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    ...
                    if (isinstance(current_board, Board)) and (0 <= self.__x-1 < current_board.width):
                        ...
                        self.__x -= 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    elif (not isinstance(current_board, Board)) and (0 <= self.__x-1 < current_board.width):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__x -= 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)

                elif (direction == 'up'):
                    if (isinstance(current_board, Board)) and (0 <= self.__y-1 < current_board.height):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__y -= 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    elif (not isinstance(current_board)) and (0 <= self.__y-1 < current_board.height):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__y -= 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    ...
                    if (isinstance(current_board, Board)) and (0 <= self.__y+1 < current_board.height):
                        ...
                        self.__y += 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
                    elif (isinstance(current_board, Board)) and (0 <= self.__y+1 < current_board.height):
                        current_board.get_cell(self.__x, self.__y).remove_content(self)
                        self.__y += 1
                        current_board.get_cell(self.__x, self.__y).add_content(self)
    @property
        ...
        def printer():
            ...
            while not is_game_over:
                ...
                if isinstance(current_board, Board):
                    ...
                    LINE = (((CELL_WIDTH + 1) * len(current_board[0])) + 1) * "-" + "\n"
                    FINAL_BOARD = LINE
