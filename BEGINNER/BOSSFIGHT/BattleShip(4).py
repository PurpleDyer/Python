...
class Ship:
    ...
    def create_ship(self):
        ...
        while ship_length_counter < self.__ship_length:
            ...
            if (self.__ship_direction == 'left') and (0 <= self.__x < board.board_width):
            ...
            elif (self.__ship_direction == 'right') and (0 <= self.__x < board.board_width):
                if not board.get_cell(self.__x, self.__y).has_typ(ShipPart):
                    ship = ShipPart()
                    board.get_cell(self.__x, self.__y).clear_cell()
                    board.get_cell(self.__x, self.__y).add_content(ship)
            ...
            elif (self.__ship_direction == 'down') and (0 <= self.__y < board.board_height):
                if not board.get_cell(self.__x, self.__y).has_typ(ShipPart):
                    ship = ShipPart()
                    board.get_cell(self.__x, self.__y).clear_cell()
                    board.get_cell(self.__x, self.__y).add_content(ship)
            ...
            elif (self.__ship_direction == 'up') and (0 <= self.__y < board.board_height):
                if not board.get_cell(self.__x, self.__y).has_typ(ShipPart):
                    ship = ShipPart()
                    board.get_cell(self.__x, self.__y).clear_cell()
                    board.get_cell(self.__x, self.__y).add_content(ship)
